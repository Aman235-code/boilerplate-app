    ...
    return (
      <div className="relative my-2 rounded-2xl overflow-hidden bg-gray-800 group">
        ...
        <button
          ...
          className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 flex items-center gap-1 bg-gray-800 text-white hover:cursor-pointer text-xs px-2 py-1 rounded-lg shadow-md transition-opacity"
